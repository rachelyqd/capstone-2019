...
bool wiced_hci_ans_command_set_supported_new_alert_category(wiced_bt_anp_alert_data_t *p_data)
{
    ...
    return wiced_hci_send_command(HCI_CONTROL_ANS_COMMAND_SET_SUPPORTED_NEW_ALERT_CATEGORIES, cmd, p_cmd - cmd);
}
...
bool wiced_hci_ans_command_set_supported_unread_alert_category(wiced_bt_anp_alert_data_t *p_data)
{
    ...
    return wiced_hci_send_command(HCI_CONTROL_ANS_COMMAND_SET_SUPPORTED_UNREAD_ALERT_CATEGORIES, cmd, p_cmd - cmd);
}
...
bool wiced_hci_ans_command_generate_alert(wiced_bt_anp_alert_category_data_t *p_data)
{
    ...
    return wiced_hci_send_command(HCI_CONTROL_ANS_COMMAND_GENERATE_ALERT, cmd, p_cmd - cmd);
}
...
bool wiced_hci_ans_command_clear_alert(wiced_bt_anp_alert_category_data_t *p_data)
{
    ...
    return wiced_hci_send_command(HCI_CONTROL_ANS_COMMAND_CLEAR_ALERT, cmd, p_cmd - cmd);
}
...
bool wiced_hci_anc_command_control_alerts(wiced_bt_anc_control_alert_data_t *p_data)
{
    ...
    return wiced_hci_send_command(HCI_CONTROL_ANC_COMMAND_CONTROL_ALERTS, cmd, p_cmd - cmd);
}
