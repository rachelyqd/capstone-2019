...
bool wiced_hci_ag_connect(wiced_bt_ag_connect_connect_data_t *p_data)
{
    ...
    return wiced_hci_send_command(HCI_CONTROL_AG_COMMAND_CONNECT, cmd, p_cmd - cmd);
}
...
bool wiced_hci_ag_disconnect(wiced_bt_ag_disconnect_data_t *p_data)
{
    ...
    return wiced_hci_send_command(HCI_CONTROL_AG_COMMAND_DISCONNECT, cmd, p_cmd - cmd);
...
bool wiced_hci_ag_audio_open(wiced_bt_ag_audio_open_data_t *p_data)
{
    ...
    return wiced_hci_send_command(HCI_CONTROL_AG_COMMAND_OPEN_AUDIO, cmd, p_cmd - cmd);
}
...
bool wiced_hci_ag_audio_close(wiced_bt_ag_audio_close_data_t *p_data)
{
    ...
    return wiced_hci_send_command(HCI_CONTROL_AG_COMMAND_CLOSE_AUDIO, cmd, p_cmd - cmd);
