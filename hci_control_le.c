...
#ifdef CYW43012C0
    wiced_bt_gatt_value_t *p_write = ( wiced_bt_gatt_value_t* )watch_get_buffer( GATT_RESPONSE_SIZE( 2 ) );
#else
...
#ifdef CYW43012C0
        p_write_req = (wiced_bt_gatt_value_t *)watch_get_buffer( write_req_len );
#else
