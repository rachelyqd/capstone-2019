 ...
 * The typical use case for this profile is, headset wirelessly connected to mobile phone
 * enabling users to perform telephony functions through headset .
...
typedef struct
{
    ...
    union
    {
        ...
        wiced_bt_hfp_hf_codec_t              selected_codec;   /**< Paylaod for WICED_BT_HFP_HFP_CODEC_SET_EVT */
        wiced_bt_hfp_hf_active_call_t        active_call;      /**< Paylaod for WICED_BT_HFP_HFP_ACTIVE_CALL_EVT */
        uint8_t                              error_code;       /**< Paylaod for WICED_BT_HFP_HF_CME_ERROR_EVT */
    };
