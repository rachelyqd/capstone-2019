...
#define HCI_CONTROL_COMMAND_GET_CONNECTION_INFO             ( ( HCI_CONTROL_GROUP_DEVICE << 8 ) | 0x13 )    /* get connected device     */
...
#define HCI_CONTROL_MESH_COMMAND_SCAN_UNPROVISIONED                         ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x05 )  /* Sends command to start/stop scanning for unprovisioned devices */
#define HCI_CONTROL_MESH_COMMAND_PROVISION_CONNECT                          ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x06 )  /* Sends command to establish provisioning link to remote device */
#define HCI_CONTROL_MESH_COMMAND_PROVISION_DISCONNECT                       ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x07 )  /* Sends command to disconnect provisioning link with remote device */
#define HCI_CONTROL_MESH_COMMAND_PROVISION_START                            ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x08 )  /* Sends command to start provisioning of the remote device */
#define HCI_CONTROL_MESH_COMMAND_PROVISION_OOB_CONFIGURE                    ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x09 )  /* Sends out of band configuration for provisioning device */
#define HCI_CONTROL_MESH_COMMAND_PROVISION_OOB_VALUE                        ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x0a )  /* Sends command with out of band value for confirmation calculation */
#define HCI_CONTROL_MESH_COMMAND_SEARCH_PROXY                               ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x0b )  /* Sends a command to start/stop scanning for GATT proxy devices */
#define HCI_CONTROL_MESH_COMMAND_PROXY_CONNECT                              ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x0c )  /* Sends a command to connect to a GATT proxy devices */
#define HCI_CONTROL_MESH_COMMAND_PROXY_DISCONNECT                           ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x0d )  /* Sends a command to disconnect to a GATT proxy devices */
#define HCI_CONTROL_MESH_COMMAND_PROXY_FILTER_TYPE_SET                      ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x0e )  /* Set Proxy Filter Type */
#define HCI_CONTROL_MESH_COMMAND_PROXY_FILTER_ADDRESSES_ADD                 ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x0f )  /* Add Addresses to Filter */
#define HCI_CONTROL_MESH_COMMAND_PROXY_FILTER_ADDRESSES_DELETE              ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x10 )  /* Remove Addresses to Filter  */

#define HCI_CONTROL_MESH_COMMAND_ONOFF_GET                                  ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x11 )  /* Generic On/Off Get Command */
#define HCI_CONTROL_MESH_COMMAND_ONOFF_SET                                  ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x12 )  /* Generic On/Off Get Command */

#define HCI_CONTROL_MESH_COMMAND_LEVEL_GET                                  ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x13 )  /* Generic Level Client Get Command */
#define HCI_CONTROL_MESH_COMMAND_LEVEL_SET                                  ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x14 )  /* Generic Level Client Set Command */
#define HCI_CONTROL_MESH_COMMAND_LEVEL_DELTA_SET                            ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x15 )  /* Generic Level Client Delta Command */
#define HCI_CONTROL_MESH_COMMAND_LEVEL_MOVE_SET                             ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x16 )  /* Generic Level Client Move Command */

#define HCI_CONTROL_MESH_COMMAND_DEF_TRANS_TIME_GET                         ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x17 )  /* Generic Default Transition Time Set Command */
#define HCI_CONTROL_MESH_COMMAND_DEF_TRANS_TIME_SET                         ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x18 )  /* Generic Default Transition Time Get Command */

#define HCI_CONTROL_MESH_COMMAND_ONPOWERUP_GET                              ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x19 )  /* Power On/Off Set Command */
#define HCI_CONTROL_MESH_COMMAND_ONPOWERUP_SET                              ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x1a )  /* Power On/Off Get Command */

#define HCI_CONTROL_MESH_COMMAND_POWER_LEVEL_GET                            ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x1b )  /* Generic Power Level Get Command */
#define HCI_CONTROL_MESH_COMMAND_POWER_LEVEL_SET                            ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x1c )  /* Generic Power Level Set Command */
#define HCI_CONTROL_MESH_COMMAND_POWER_LEVEL_LAST_GET                       ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x1d )  /* Generic Power Level Last Get Command */
#define HCI_CONTROL_MESH_COMMAND_POWER_LEVEL_DEFAULT_GET                    ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x1e )  /* Generic Power Level Default Get Command */
#define HCI_CONTROL_MESH_COMMAND_POWER_LEVEL_DEFAULT_SET                    ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x1f )  /* Generic Power Level Default Set Command */
#define HCI_CONTROL_MESH_COMMAND_POWER_LEVEL_RANGE_GET                      ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x20 )  /* Generic Power Level Range Get Command */
#define HCI_CONTROL_MESH_COMMAND_POWER_LEVEL_RANGE_SET                      ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x21 )  /* Generic Power Level Range Set Command */

#define HCI_CONTROL_MESH_COMMAND_LOCATION_GLOBAL_SET                        ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x22 )  /* Set Global Location data */
#define HCI_CONTROL_MESH_COMMAND_LOCATION_LOCAL_SET                         ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x23 )  /* Set Local Location data */
#define HCI_CONTROL_MESH_COMMAND_LOCATION_GLOBAL_GET                        ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x24 )  /* Get Global Location data */
#define HCI_CONTROL_MESH_COMMAND_LOCATION_LOCAL_GET                         ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x25 )  /* Get_Local Location data */

#define HCI_CONTROL_MESH_COMMAND_BATTERY_GET                                ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x26 )  /* Battery get state */
#define HCI_CONTROL_MESH_COMMAND_BATTERY_SET                                ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x27 )  /* Battery state changed */

#define HCI_CONTROL_MESH_COMMAND_PROPERTIES_GET                             ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x28 )  /* Generic Set Value of the Property */
#define HCI_CONTROL_MESH_COMMAND_PROPERTY_GET                               ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x29 )  /* Generic Set Value of the Property */
#define HCI_CONTROL_MESH_COMMAND_PROPERTY_SET                               ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x2a )  /* Generic Value of the Property Changed Status*/

#define HCI_CONTROL_MESH_COMMAND_LIGHT_LIGHTNESS_GET                        ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x2b )  /* Light Lightness Get Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_LIGHTNESS_SET                        ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x2c )  /* Light Lightness Set Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_LIGHTNESS_LINEAR_GET                 ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x2d )  /* Light Lightness Linear Get Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_LIGHTNESS_LINEAR_SET                 ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x2e )  /* Light Lightness Linear Set Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_LIGHTNESS_LAST_GET                   ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x2f )  /* Light Lightness Last Get Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_LIGHTNESS_DEFAULT_GET                ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x30 )  /* Light Lightness Default Get Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_LIGHTNESS_DEFAULT_SET                ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x31 )  /* Light Lightness Default Set Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_LIGHTNESS_RANGE_GET                  ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x32 )  /* Light Lightness Range Get Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_LIGHTNESS_RANGE_SET                  ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x33 )  /* Light Lightness Range Set Command */

#define HCI_CONTROL_MESH_COMMAND_LIGHT_CTL_GET                              ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x34 )  /* Light CTL Client Get Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_CTL_SET                              ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x35 )  /* Light CTL Client Set Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_CTL_TEMPERATURE_GET                  ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x36 )  /* Light CTL Client Temperature Get Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_CTL_TEMPERATURE_SET                  ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x37 )  /* Light CTL Client Temperature Set Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_CTL_TEMPERATURE_RANGE_GET            ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x38 )  /* Light CTL Client Temperature Range Get Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_CTL_TEMPERATURE_RANGE_SET            ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x39 )  /* Light CTL Client Temperature Range Set Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_CTL_DEFAULT_GET                      ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x3a )  /* Light CTL Client Default Get Command */
#define HCI_CONTROL_MESH_COMMAND_LIGHT_CTL_DEFAULT_SET                      ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0x3b )  /* Light CTL Client Default Set Command */
...
#define HCI_CONTROL_EVENT_CONNECTED_DEVICE                  ( ( HCI_CONTROL_GROUP_DEVICE << 8 ) | 0x19 )    /* Connection Status */
