...
#define WICED_DEVICE_NAME                       "BlueHubPhilip"
...
#else
#ifdef CYW43012C0
    .max_number_of_buffer_pools         = 9,                                                           /**< Maximum number of buffer pools in p_btm_cfg_buf_pools and by wiced_create_pool */
#else
...
const wiced_bt_audio_config_buffer_t wiced_bt_audio_buf_config = {
    ...
    .audio_tx_buffer_size             =   11000,
    .audio_codec_buffer_size          =   0x2000
